 ...
 *
 * @templates T the type of the action's `type` tag.
 */
 ...
 *
 * @templates S The type of state consumed and produced by this reducer.
 * @templates A The type of actions the reducer can potentially respond to.
 */
 ...
 *
 * @templates A The type of actions the reducers can potentially respond to.
 */
 ...
 * reducer functions.
 *
 * @templates S Combined state object type.
 *
 ...
 *
 * @templates A The type of things (actions or otherwise) which may be
 *   dispatched.
 */
 ...
 *
 * @templates S The type of state held by this store.
 * @templates A the type of actions which may be dispatched by this store.
 */
 ...
 *
 * @templates S The type of state to be held by the store.
 * @templates A The type of actions which may be dispatched.
 * @templates Ext Store extension that is mixed in to the Store type.
 * @templates StateExt State extension that is mixed into the state type.
 */
 ...
 *
 * @templates Ext Store extension that is mixed into the Store type.
 * @templates StateExt State extension that is mixed into the state type.
 */
 ...
 *
 * @templates DispatchExt Extra Dispatch signature added by this middleware.
 * @templates S The type of the state supported by this middleware.
 * @templates D The type of Dispatch of the store where this middleware is
 *   installed.
 */
 ...
 *
 * @templates Ext Dispatch signature added by a middleware.
 * @templates S The type of the state supported by a middleware.
 */
 ...
 *
 * @templates A Returned action type.
 */
